...
func newEvent(db *gorm.DB, opts ...gen.DOOption) event {
	...
	_event.PosterURL = field.NewString(tableName, "poster_url")
	_event.CategoryID = field.NewInt32(tableName, "category_id")
	_event.VenueID = field.NewInt64(tableName, "venue_id")
	_event.CityID = field.NewInt64(tableName, "city_id")
	_event.Artist = field.NewString(tableName, "artist")
	_event.EventStartTime = field.NewTime(tableName, "event_start_time")
	_event.EventEndTime = field.NewTime(tableName, "event_end_time")
	_event.SaleStartTime = field.NewTime(tableName, "sale_start_time")
	_event.SaleEndTime = field.NewTime(tableName, "sale_end_time")
	_event.Status = field.NewInt16(tableName, "status")
	_event.PurchaseLimit = field.NewInt32(tableName, "purchase_limit")
	_event.NeedRealName = field.NewInt16(tableName, "need_real_name")
	_event.TicketType = field.NewInt16(tableName, "ticket_type")
	_event.CreatedBy = field.NewInt64(tableName, "created_by")
...
type event struct {
	...
	CityID         field.Int64
	Artist         field.String
	EventStartTime field.Time
	EventEndTime   field.Time
	SaleStartTime  field.Time
	SaleEndTime    field.Time
	Status         field.Int16
	PurchaseLimit  field.Int32
	NeedRealName   field.Int16
	TicketType     field.Int16
...
func (e *event) updateTableName(table string) *event {
	...
	e.PosterURL = field.NewString(table, "poster_url")
	e.CategoryID = field.NewInt32(table, "category_id")
	e.VenueID = field.NewInt64(table, "venue_id")
	e.CityID = field.NewInt64(table, "city_id")
	e.Artist = field.NewString(table, "artist")
	e.EventStartTime = field.NewTime(table, "event_start_time")
	e.EventEndTime = field.NewTime(table, "event_end_time")
	e.SaleStartTime = field.NewTime(table, "sale_start_time")
	e.SaleEndTime = field.NewTime(table, "sale_end_time")
	e.Status = field.NewInt16(table, "status")
	e.PurchaseLimit = field.NewInt32(table, "purchase_limit")
	e.NeedRealName = field.NewInt16(table, "need_real_name")
	e.TicketType = field.NewInt16(table, "ticket_type")
	e.CreatedBy = field.NewInt64(table, "created_by")
...
func (e *event) fillFieldMap() {
	...
	e.fieldMap["poster_url"] = e.PosterURL
	e.fieldMap["category_id"] = e.CategoryID
	e.fieldMap["venue_id"] = e.VenueID
	e.fieldMap["city_id"] = e.CityID
	e.fieldMap["artist"] = e.Artist
	e.fieldMap["event_start_time"] = e.EventStartTime
	e.fieldMap["event_end_time"] = e.EventEndTime
	e.fieldMap["sale_start_time"] = e.SaleStartTime
	e.fieldMap["sale_end_time"] = e.SaleEndTime
	e.fieldMap["status"] = e.Status
	e.fieldMap["purchase_limit"] = e.PurchaseLimit
	e.fieldMap["need_real_name"] = e.NeedRealName
	e.fieldMap["ticket_type"] = e.TicketType
